...
import com.anthzh.tool.viewhelper.wrapper.CheckedTextViewWrapper;

public class CheckedTextViewHelper extends CheckedTextViewWrapper<CheckedTextViewHelper> {
